...
<table width="100%" border="1">
  <tr>
    <td width="30%">&nbsp; Your <?php echo $provider; ?> application CLIENT_ID </td>
    <td>&nbsp;<?php echo $GLOBAL_HYBRID_AUTH_IDPROVIDERS[ $provider ]["keys"]["CLIENT_ID"] ?></td>
  </tr>
  <tr>
    <td>&nbsp; Your <?php echo $provider; ?> application CLIENT_SECRET </td>
    <td>&nbsp;<?php echo $GLOBAL_HYBRID_AUTH_IDPROVIDERS[ $provider ]["keys"]["CLIENT_SECRET"] ?></td>
  </tr>
</table>
